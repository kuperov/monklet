...
urlpatterns = [
    ...
    path("p/<str:pk>/data", data.index, name="data"),
    path("p/<str:pk>/data/new", cases.new_case, name="case-new"),
    path("p/<str:pk>/data/cases", data.cases, name="cases"),
    path("p/<str:pk>/data/import", data.import_chats, name="import-chats"),
    path("p/<str:pk>/themes", analysis.themes, name="themes"),
    path("p/<str:pk>/query", analysis.themes, name="query"),
