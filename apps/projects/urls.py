...
urlpatterns = [
    ...
    path("interviews/<str:pk>/conversation", interviews.conversation, name="interview-conversation"),
    ...
    path("projects/<str:pk>/transcripts/upload", transcripts.new, name="project-transcripts-upload"),
    path("projects/<str:pk>/transcripts/import_chats", transcripts.project_import_chats, name="project-import-chats"),
