...
user_data = [
    ...
    {
        "email": "david.hernandez@yahoo.com",
        "password": "ilovemypet",
    ...
    {
        "email": "grace.walker@outlook.com",
        "password": "apptest123",
        "name": "Grace Walker",
    },
    {"email": "henry.davis@email.com", "password": "securepass", "name": "Henry Davis"},
    {
        "email": "isla.garcia@workmail.com",
        "password": "mysecureapp",
        "name": "Isla Garcia",
    },
    {
        "email": "kimberly.young@gmail.com",
        "password": "supersecure",
        "name": "Kimberly Young",
    },
    {"email": "liam.lewis@hotmail.com", "password": "verystrong", "name": "Liam Lewis"},
    {
        "email": "mia.williams@outlook.com",
        "password": "ilovedogs",
        "name": "Mia Williams",
    },
...
projects = [
    ...
    {
        "name": "Stress in first responders",
        "owner": 0,
        "members": [],
        "invited": [0, 1, 2, 3],
    },
    {
        "name": "Pressure to perform at school",
        "owner": 1,
        "members": [],
        "invited": [0, 1, 2, 3],
    },
    {
        "name": "Climate change and coastal communities",
        "owner": 0,
        "members": [1, 2, 3],
        "invited": [4],
    },
    ...
    {
        "name": "Procrastination among bus drivers",
        "owner": 3,
        "members": [0, 1, 2],
        "invited": [1, 2],
    },
    {
        "name": "Artificial intelligence researchers",
        "owner": 0,
        "members": [1, 3],
        "invited": [1],
    },
    ...
    {
        "name": "Social media on mental health",
        "owner": 2,
        "members": [0, 1, 3],
        "invited": [3],
    },
    {
        "name": "Bilingualism and discrimination",
        "owner": 3,
        "members": [0, 1, 2],
        "invited": [4],
    },
    ...
    {
        "name": "Toddlers and space exploration",
        "owner": 1,
        "members": [0, 2],
        "invited": [],
    },
    {
        "name": "Video games and children",
        "owner": 2,
        "members": [0, 1, 3],
        "invited": [3],
    },
    ...
    {
        "name": "Marital status and persuasion",
        "owner": 0,
        "members": [1, 3],
        "invited": [1, 2],
    },
    {
        "name": "Artificial intelligence and real estate",
        "owner": 1,
        "members": [0, 2],
        "invited": [],
    },
    {
        "name": "Anxiety about automation",
        "owner": 2,
        "members": [0, 1, 3],
        "invited": [],
    },
...
def main():
    ...
    try:
        ...
        for spec in projects:
            ...
            proj = Project(
                owner=owner, name=spec["name"], description="Lorem ipsum dolor sit amet"
            )
            proj.save()
            for i, m in enumerate(spec["members"]):
                name = user_data[m]["name"]
                mship = Member(
                    project=proj, user=users[m], role=["editor", "viewer"][i % 2]
                )
                mship.save()
